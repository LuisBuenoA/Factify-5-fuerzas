...
data_proveedores = {
    ...
    'Ahorro de costes por publicidad': [5000, 4500, 4000, 3500, 3000, 2500, 2000, 4000, 2100, 3300]
}

# Convertir a DataFrame
df_proveedores = pd.DataFrame(data_proveedores)

# Calcular el "Coste total real" como la suma de "Coste por sus fuentes" y "Ahorro de costes por publicidad"
df_proveedores['Coste total real'] = df_proveedores['Coste por sus fuentes'] + df_proveedores['Ahorro de costes por publicidad']
